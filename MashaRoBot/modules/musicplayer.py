...
__help__ = """
 ...
 Anisha plays music in your group's voice chat
 
 Assistant name >> ꧁ @Raksha_op ꧂
 
⚙️Setting up 
1) Make bot admin
2) Start a voice chat
3) Try `/play [song name]` for the first time by an admin
*) If userbot joined enjoy music, If not add @Raksha_op to your group and retry
  Commands
...
=>> More tools 📲
  ...
  /userbotjoin: Invite @Raksha_op Userbot to your chat
